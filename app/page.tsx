        ...
        <div className="max-w-7xl mx-auto px-6 grid gap-12 md:grid-cols-2 items-center">
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <a href="#contact" className="bg-accent px-5 py-3 rounded-2xl shadow">Contact Us</a>
              <a href="#projects" className="border border-gray-200 px-5 py-3 rounded-2xl">Our Projects</a>
            </div>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            About IOT ENGINEERING
          </h1>
          <p className="text-gray-600 mb-4 leading-relaxed">
            At <strong>IOT ENGINEERING</strong>, we specialize in providing cutting-edge
